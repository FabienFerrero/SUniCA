...
void SetFSK(int i){
 if(i==0){
  ...
  Serial.println("AT+PFDEV=600 // Set Freq deviation [600:200000] Hz ");// Set Freq dev
  delay(200);
  mySerial1.println("AT+PSEND=00000000000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF00000000000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF");// Send 96 bytes 
  Serial.println("AT+PSEND=00000000000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF00000000000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF// Send 192 bytes"); //Send Hello World 
  flush_serial_AT(true);
 }
 if(i==1){
...
void StartCW(){
   mySerial1.println("AT+CW=868000000:10:1"); // Set CW 10dBm for 1s
   Serial.println("AT+CW=868000000:10:1 // Set CW 10dBm for 1s");
  delay(200);
  flush_serial_AT(true);   
}
